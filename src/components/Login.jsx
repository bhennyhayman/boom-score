...
const Login = () => {
  ...
  return (
      ...
      <div className='h-screen bg-cyan-950 text-center'>
        ...
        <form className='flex flex-col bg-gray-800 max-sm:mx-10 mx-auto mt-5 rounded p-2'>
          <input className='mx-auto w-60 mt-5 bg-white text-black text-[18px] px-5 py-2' type="text" placeholder='Email ...' onChange={e => setEmail(e.target.value)} />
          <div className='flexflex-col items-center align-middle w-60 mx-auto '>
            <input className='w-60 mt-2 mb-3 bg-white text-black text-[18px] px-5 py-2' type="password" placeholder='Password ...' id='password' onChange={e => setPassword(e.target.value)}/>
            <span onClick={showPassword} 
            className='w-10 p-1 rounded-full text-[16px] bg-white cursor-pointer active:bg-gray-300'>👁</span>
          </div>
